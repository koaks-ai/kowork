...
export function Composer({
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute bottom-0 left-0 right-[10px] z-10 bg-white"
    >
      <div className="mx-auto w-full max-w-[860px] px-5 pb-4 sm:px-8">
        <ApprovalBanner threadId={thread.id} />
        <div
          data-chat-composer
          className="pointer-events-auto rounded-lg border border-neutral-300 bg-white shadow-sm focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500/15"
        >
          <textarea
            ref={textarea}
            value={value}
